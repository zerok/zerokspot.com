...
When you remove the main cap you will also see a quite generous ink window. As with any such window, depending on which ink you're using it might end up being completely useless. Right now I'm using [Kaweco Royal Blue](https://www.kaweco-pen.com/en/accessories/ink/ink-bottles/784/kaweco-ink-bottle-royal-blue-50-ml?c=105) (because I haven't written with that color ever since my school years) and there the window offers enough for a status indicator.
