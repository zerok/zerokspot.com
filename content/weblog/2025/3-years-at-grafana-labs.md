...
When I initially joined Grafana Labs, I worked on [release-engineering topics for Grafana](https://grafana.com/grafana/download) itself. Automated patching, back porting of fixes, CI, changelog management and so on. After about a year some folks seemed to like the way my squad was approaching things and decided that we should operate on a broader scope. That’s when we moved moved from being release engineers to joining the platform team and thereby become platform engineers, automating things on a whole new level 😁
